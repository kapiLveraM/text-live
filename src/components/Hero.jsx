...
const Hero = () => {
  return (
    <div className="py-xl-3">
      <div className="container new_container py-5 my-xl-5">
        <div className="row">
          <div className="col-lg-6 pe-lg-4 d-flex justify-content-center flex-column">
            ...
            <div className="row mx-0 pe-xl-5 pt-sm-5 pt-4 justify-content-center">
              <div
                className="col-sm-4 col-6 pt-sm-5 pt-4 text-center"
                data-aos="fade-right"
                data-aos-delay="3000"
              >
                <span>
          ...
          <div className="col-lg-6 pt-4 pt-lg-0 ps-lg-3 ">
            <h1
              className="heading text-center text-sm-start"
              data-aos="fade-left"
              data-aos-delay="2000"
            >
            ...
            <p
              className="para pt-2 text-center text-sm-start me-xl-4 pe-xl-1"
              data-aos="fade-left"
              data-aos-delay="2700"
            >
            ...
            <div className="d-sm-flex pt-4 pt-lg-5">
              <div
                className="card_1 w-100 me-sm-1 cursor_pointer"
                data-aos="fade-left"
                data-aos-delay="3000"
              >
              ...
              <div
                className="card_1 cursor_pointer bg_dark_blue ms-sm-1 mt-4 mt-sm-0 w-100"
                data-aos="fade-left"
                data-aos-delay="3000"
              >
                <p className="para text_white mb-0">boost your</p>
